...
int main() {
    ...
    cout << "In this version you battle against your friend!" << endl;
    cout << "One's score is based on the length of the valid guess" << endl;
    cout << "And it is based on how quickly you enter the word" << endl;
    cout << "Prepare to have fun, ruin friendships and BOGGLE!" << endl;
    cout << endl;
