...
namespace BoggleGUI {
    ...
    const string BOARD_COLOR    = "#7e2022";
    const string DIE_COLOR      = "#E6E6E6";
    const string LETTER_COLOR   = "#023B46";
    const string DIE_COLOR_H    = "#faab22";   // _H = highlighted colors
    ...
    void initialize(int rowCount, int columnCount) {
        ...
        if (!isInitialized()) {
            ...
            setupPlayerLabels(HUMAN, "Player 1");
            setupPlayerLabels(COMPUTER, "Player 2");
